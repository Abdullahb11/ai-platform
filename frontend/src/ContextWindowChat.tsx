...
function getUsageColor(percent: number): string {
  if (percent < 60) return 'var(--t-good)';
  if (percent < 85) return 'var(--t-warn)';
  return 'var(--t-bad)';
}
...
export function ContextWindowChat() {
      ...
      <div className="chat-area">
        <header>
          <nav className="chat-breadcrumbs">
            <a className="chat-crumb" href="#/">AI Platform</a>
            <span className="chat-crumb-sep">/</span>
            <a className="chat-crumb" href="#/context-window">Context Window</a>
            <span className="chat-crumb-sep">/</span>
            <span className="chat-crumb chat-crumb-current">Current Implementation</span>
          </nav>
          <h1 className="title">Context Window</h1>
          <p className="subtitle">Sliding-Window Implementation</p>
        </header>
...
export default ContextWindowChat;
